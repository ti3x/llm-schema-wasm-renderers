/* @ts-self-types="./json_render_wasm.d.ts" */
...
export class Template {
    ...
    constructor(spec_json) {
        try {
            ...
            wasm.template_new(retptr, ptr0, len0);
            ...
            this.__wbg_ptr = r0;
            TemplateFinalization.register(this, this.__wbg_ptr, this);
            return this;
        } finally {
    ...
    render(state_json) {
        ...
        try {
            ...
            const len0 = WASM_VECTOR_LEN;
            wasm.template_render(retptr, this.__wbg_ptr, ptr0, len0);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
 ...
 * @returns {string}
 */
export function compile(spec_json, state_json) {
    let deferred4_0;
    let deferred4_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./json_render_wasm_bg.js": import0,
    };
}

const TemplateFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_template_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('json_render_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
